...
const busanConfig: CityConfig = {
  ...
  emoji: "🌊",
  planningReady: true,
  // Version 1 정적 목록(Supabase 응답 전 초기 상태·빈 응답 fallback). 2026-09-01 legacy retirement:
  // 황령산 야경 트레일·장산 트레일·이기대(city_spots 5/6/7/29 퇴역)는 제거 — 장산은 canonical id 30 이 DB 로 제공된다.
  staticSpots: [
    {
      id: 6,
      name: "Haeundae Beach",
