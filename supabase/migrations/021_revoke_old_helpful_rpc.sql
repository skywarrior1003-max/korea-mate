-- 021: increment_trip_helpful anon/authenticated EXECUTE 차단
...
-- Supabase 기본 권한이 REVOKE FROM PUBLIC을 우회하므로 명시적 차단

REVOKE EXECUTE ON FUNCTION public.increment_trip_helpful(UUID) FROM anon;
REVOKE EXECUTE ON FUNCTION public.increment_trip_helpful(UUID) FROM authenticated;
